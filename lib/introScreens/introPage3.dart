...
class IntroPage3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   Align(alignment: Alignment(0.50,0.55),
     child: Padding(
       padding: const EdgeInsets.only(left: 50,right: 50),
       child: Text('We provide an online bus admission service for the participating schools, facilitating the application process for securing transportation services through our digital platform',
